...
class SkillSandbox:
    ...
    def execute_skill(self, skill_id: str, script_path: str, args: Optional[List[str]] = None, version: int = 1, timeout: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    def _record_state(self, skill_id: str, version: int, state: str, return_code: int, stdout: str, stderr: str, duration: float) -> Dict[str, Any]:
        """
